...
classroom_1_flavor = "You are in Classroom 1. A mix of modular tables and chairs fills the room, designed for interactive learning. A smartboard stretches across one wall, surrounded by writable whiteboard surfaces.\nObjects of interest: smartboard, lab stools, supply drawers, rusty door.\nTo the South is the Atrium. To the East is the supply closet."
...
classroom_2_flavor = "You are in Classroom 2. Rows of lab benches are equipped with sinks and microscopes, with overhead hoods lining. The room is designed for hands-on experimentation.\nObjects of interest: lab benches, safety cabinet, wall-mounted monitor.\nTo the West is the Atrium."
...
printer_flavor = "The 3D printer made some minor noise. On the platform sits a newly printed object—a gold key is put next to the unfinished project. You found: gold key."
